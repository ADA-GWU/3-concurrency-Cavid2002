...
Elapsed time in milliseconds: 0.026
```
...
Multi-threaded mode selected...
Number of threads: 12
Elapsed time in milliseconds: 0.023
```
...
Multi-threaded mode selected...
Number of threads: 12
Elapsed time in milliseconds: 0.024
```
